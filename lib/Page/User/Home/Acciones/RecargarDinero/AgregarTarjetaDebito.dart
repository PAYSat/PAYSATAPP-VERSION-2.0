...
class AgregarTarjetaDebito extends StatefulWidget {
  const AgregarTarjetaDebito({Key? key}) : super(key: key);

  @override
  _AgregarTarjetaDebitoState createState() => _AgregarTarjetaDebitoState();
}

class _AgregarTarjetaDebitoState extends State<AgregarTarjetaDebito> {
  ...
  String _getStepTitle() {
    switch (_currentStep) {
      ...
      case 1:
        return 'Ingresa el número de tu tarjeta débito';
      case 2:
  ...
  void _nextStep() {
    if (_formKey.currentState!.validate()) {
      if (_currentStep < 3) {
        ...
        cardProvider.AddCardVisaDebito(tarjetaDebito, context,
            cardType: "debit");
      }
    }
  }
