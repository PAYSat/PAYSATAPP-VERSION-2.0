...
import 'package:proyectos_flutter/Page/User/Home/Acciones/RecargarDinero/AgregarTarjetaDebito.dart';
import 'package:proyectos_flutter/Page/User/Home/Acciones/RecargarDinero/ConfirmacionRecargarDebito.dart';
...
class ListaTarjetaDebito extends StatefulWidget {
  const ListaTarjetaDebito({Key? key}) : super(key: key);

  @override
  State<ListaTarjetaDebito> createState() => _ListaTarjetaDebitoState();
}

class _ListaTarjetaDebitoState extends State<ListaTarjetaDebito> {
    ...
    try {
      ...
      for (int index in _selectedCards) {
        if (index < _cards.length) {
          await cardProvider.deleteCardVisaDebito(_cards[index].id!, context);
        }
      }
      setState(() {
        ...
        onTap: () {
          if (_isSelectionMode) {
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    ConfirmacionRecargarDebito(selectedCard: card),
              ),
            );
          }
        },
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Registra tus tarjetas débito y evita tiempos\npara enviar o recargar dinero.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 16,
                    color: Colors.grey,
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const AgregarTarjetaDebito(),
            ),
          ).then((_) => _loadCards());
        },
      ),
