...
class ConfirmacionRecargarDebito extends StatefulWidget {
  final CreditCardVisa selectedCard;

  const ConfirmacionRecargarDebito({
    Key? key,
    required this.selectedCard,
  }) : super(key: key);

  @override
  _ConfirmacionRecargarDebitoState createState() =>
      _ConfirmacionRecargarDebitoState();
}

class _ConfirmacionRecargarDebitoState
    extends State<ConfirmacionRecargarDebito> {
  ...
  Future<void> _recargar() async {
    try {
      if (amount > 0) {
        await _recargasProvider.recargarSaldodesdeDebito(
          context,
